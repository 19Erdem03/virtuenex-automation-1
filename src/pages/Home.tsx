...
const faqs = [
  {
    ...
    answer: 'We work with businesses across all industries, from e-commerce and SaaS to professional services, real estate, and consulting. If you have repetitive processes, high customer volume, or sales workflows that need optimization, AI automation can transform your operations.',
  },
  {
    question: 'How long does implementation take?',
    answer: 'Implementation timelines vary based on complexity. Simple automation systems can be deployed in 2-4 weeks, while comprehensive custom solutions typically take 6-12 weeks. We provide a detailed timeline during the discovery phase.',
  },
  {
    question: 'Do I need technical knowledge to use these systems?',
    answer: 'Not at all. We design our systems to be intuitive and user-friendly. We provide complete training and documentation, plus ongoing support to ensure your team can leverage the automation effectively without technical expertise.',
  },
  {
    question: 'How is this different from other automation tools?',
    answer: 'Unlike off-the-shelf tools, we engineer custom AI systems tailored to your specific business processes. We integrate with your existing tech stack, train models on your data, and provide ongoing optimization, not just templates.',
  },
];
  ...
  return (
    <>
      ...
      <SectionContainer style={{ display: 'flex', justifyContent: 'center', padding: '0 1.5rem 2rem' }}>
        <ViewAllButton to="/contact">Book a Free Consultation</ViewAllButton>
      </SectionContainer>
      ...
      <Section>
        <SectionContainer>
          ...
          <ViewAllButton to="/services">View All Solutions</ViewAllButton>
        </SectionContainer>
      </Section>
      ...
      <SectionContainer style={{ display: 'flex', justifyContent: 'center', padding: '0 1.5rem 2rem' }}>
        <ViewAllButton to="/contact">Book a Strategy Call</ViewAllButton>
      </SectionContainer>
        ...
        <SectionContainer>
          ...
          <ValueGrid>
            ...
            >
              ...
              <ValueDescription>
                We deploy your first automation in weeks, not months. See results from day one.
              </ValueDescription>
            </ValueCard>
            ...
            >
              ...
              <ValueDescription>
                Track every hour saved, every lead captured, every deal closed. Data-driven results.
              </ValueDescription>
            </ValueCard>
            ...
            >
              ...
              <ValueDescription>
                Built to evolve with AI advancements. Your automation gets smarter over time.
              </ValueDescription>
            </ValueCard>
          </ValueGrid>
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '3rem' }}>
            <ViewAllButton to="/contact">Get Started</ViewAllButton>
          </div>
        </SectionContainer>
      </Section>
